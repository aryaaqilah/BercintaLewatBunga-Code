...
const Navbar = () => {
  return (
    <div className='NavBar'>
      <NavLink to="/"><img src={PrimaryLogoLight} alt="Primary Logo" className='NavBarLogo' /></NavLink>
      ...
      <ul>
        ...
        <li><NavLink to="/login"><button className="NavBarButton">Login</button></NavLink></li>
      </ul>
    </div>
  )
}
