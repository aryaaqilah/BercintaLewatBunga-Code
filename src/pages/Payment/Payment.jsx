...
function MainSection({ selectedProduct, addressData, adminFee, discountData }) {
  ...
  const handleCardSelect = async () => {
    ...
    try {
      ...
      // RecipientNumber, RecipientName, Province, City, District, PostalCode, Detail
      const addressPayload = {
        RecipientName: addressData.RecipientName,
        RecipientNumber: 89522222333, // Contoh nomor tetap
        Province: "6942b33b502f86ae7fc21ac6",
        City: "6942b33b502f86ae7fc21ac8",
        District: "6942b33b502f86ae7fc21aca", // Sementara disamakan jika input District tidak ada
        PostalCode: "6942b33b502f86ae7fc21acc",
      ...
      const orderPayload = {
        Status: 1,
        Address: savedAddress._id, // Mengambil ID dari hasil POST pertama
        Delivery: "6942b33b502f86ae7fc21abe",
        Product: "69440c04d3e7dc46622edd26",
        ProductPrice: productPrice,
        AdministrationFee: adminFee[0]._id,
        Discount: discountData[0]._id || null,
        Total: totalOrder,
      };
